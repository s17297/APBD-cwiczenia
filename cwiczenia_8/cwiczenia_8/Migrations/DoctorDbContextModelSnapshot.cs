...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cwiczenia_8.Models.Doctor", b =>
                {
            ...
            modelBuilder.Entity("cwiczenia_8.Models.Medicament", b =>
                {
            ...
            modelBuilder.Entity("cwiczenia_8.Models.Patient", b =>
                {
            ...
            modelBuilder.Entity("cwiczenia_8.Models.Prescription", b =>
                {
            ...
            modelBuilder.Entity("cwiczenia_8.Models.Prescription_Medicament", b =>
                {
                    b.Property<int>("IdMedicament")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("cwiczenia_8.Models.Prescription", b =>
                {
                    b.HasOne("cwiczenia_8.Models.Doctor", "Doctor")
                        .WithMany("Prescriptions")
                        .HasForeignKey("IdDoctor")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("cwiczenia_8.Models.Patient", "Patient")
                        .WithMany("Prescriptions")
            ...
            modelBuilder.Entity("cwiczenia_8.Models.Prescription_Medicament", b =>
                {
                    b.HasOne("cwiczenia_8.Models.Medicament", "Medicament")
                        .WithMany("Prescription_Medicaments")
                        .HasForeignKey("IdMedicament")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("cwiczenia_8.Models.Prescription", "Prescription")
                        .WithMany("Prescription_Medicaments")
